...
if (!supabaseUrl || !supabaseKey) {
  console.error('❌ Erro: Verifique seu arquivo .env (SUPABASE_URL e KEY)')
  process.exit(1)
}

const supabase = createClient(supabaseUrl, supabaseKey)

// Base de Conhecimento com CONTEXTO (Tags)
const documents = [
  {
    ...
    tags: "barulho som alto música festa incomodar vizinho dormir furadeira obra martelo gritou"
  },
  {
    ...
    tags: "banho nadar convidados visitante churrasco na piscina vidro bebida cerveja roupa bóia criança"
  },
  {
    ...
    tags: "cachorro cão gato bicho estimação passear cocô focinheira latido morder solto pátio"
  },
  {
    title: "Mudanças",
    ...
    tags: "mudar transporte caminhão móveis entrar sair chegar horário agendamento nova casa"
  },
  {
    ...
    tags: "construção pedreiro pintor martelo barulho furar parede quebrar piso caçamba lixo resto material"
  },
  {
    title: "Coleta de Lixo",
    content: "Artigo 3º: Coleta diária às 07:30 e 15:30. Colocar na lixeira apenas nestes horários. Proibido aos domingos.",
    tags: "saco lixeira fedor resto comida reciclável orgânico descarte jogar fora zelador"
  },
  {
    ...
    tags: "ifood uber eats pizza correio encomenda pacote sedex mercado livre receber pedido portaria subir interfone"
  },
  {
    ...
    tags: "alugar festa aniversário churrasco reunião evento pagar boleto lista convidados limpar"
  },
  {
    ...
    tags: "carro moto estacionamento vaga parar visitante multa correr velocidade pneu pneu furado batida"
  }
]
