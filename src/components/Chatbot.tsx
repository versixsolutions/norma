...
export default function Chatbot({ isOpen, onClose }: ChatbotProps) {
  ...
  const { messages, inputText, setInputText, isTyping, messagesEndRef, handleSendMessage, handleOptionClick, createTicketFromChat } = useChatbot({ isOpen })
  ...
  return (
    ...
    >
      ...
      <MessagesList messages={messages} isTyping={isTyping} onOptionClick={handleWrappedOption} endRef={messagesEndRef} />
      <ChatInput value={inputText} onChange={setInputText} onSubmit={(e) => handleSendMessage(e)} disabled={isTyping} />
    </div>
  )
}