  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <EmptyState icon="💰" title="Sem lançamentos" description="Comece a registrar as despesas do mês." />
      ) : (
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            />
            <label htmlFor="isPaid" className="text-sm font-medium text-gray-700">Já foi pago?</label>
          </div>
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-100">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="flex-1 py-2.5 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 shadow-md disabled:opacity-50"
            >
